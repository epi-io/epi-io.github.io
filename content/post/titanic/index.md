...
This is my first project on Kaggle and my first attempt at machine learning. I'll do my best to illustrate what I've done and the logic behind my actions, but feedback is very much welcome and appreciated!
...
![Bar graph showing that most families had 2 or fewer family members with them](unnamed-chunk-11-1.png)
...
##   SibSp Parch Ticket  Fare Cabin Embarked Dataset Titles FamilySize TravelGroup
## 1     0     0 110152 86.50   B77        S   train   Miss          1          NA
## 2     0     0 110152 86.50   B79        S   train   Miss          1          NA
## 3     0     0 110152 86.50   B77        S   train   Lady          1          NA
## 4     1     1 110413 79.65   E67        S   train     Mr          3          NA
## 5     1     1 110413 79.65   E67        S   train    Mrs          3          NA
## 6     0     2 110413 79.65   E68        S   train   Miss          3          NA
```

To verify that this is working so far, I inspected the first ticket number listed (110152) on the [Titanic Passenger and Crew](https://www.encyclopedia-titanica.org/titanic-passengers-and-crew/) table of Encyclopedia Titanica. That dataset lists the same three passengers who owned those tickets, verified that the 3 women were traveling together, and indicated that two of the women (Miss Gladys Cherry and the Countess of Rothes) were cousins and the 3rd woman in their party (Miss Roberta Elizabeth Mary Maioni) was their servant. Looking at unique Ticket ID may be the only way to know that these women were travelling together. I'm feeling good that unique ticket numbers may be a good way to look at family/traveling groups, so full steam ahead!
...
##  Median : 14.454   Mode  :character   C:270    train:891   Miss   :260  
##  Mean   : 33.295                      S:914                Mrs    :197  
##  NA's   :1                                                 (Other): 18  
##    FamilySize      TravelGroup     GroupSize     
##  Min.   : 1.000   779    :  11   Min.   : 1.000  
##  Mean   : 1.884   (Other):1261   Mean   : 2.102  
...
Looks like the median price for a first class ticket departing from 'C' (Cherbourg) was 77 (in comparison to our 80). While first class tickets departing from 'Q' were only slightly more expensive (median price 90), only 3 first class passengers departed from that port. It seems far more likely that passengers 62 and 830 departed with the other 141 first-class passengers from Cherbourg.
...
Now to use this information to predict the ages of passengers with missing ages and fill in their NA values.
...
![Histogram of the known + predicted age of passengers showing that there were few passengers below age 20, with the most passengers in their early to mid 30s](unnamed-chunk-32-2.png)
...
# where Survived contains my predictions.
